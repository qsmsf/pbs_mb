...
//link plugin
    ...
    app.getToken = function(callback,failCb){
        ...
        Cordova.exec(successCallback, failCallback, "LinkPlugin", "getToken", []);
    }
...
//SzgaPlugin 系列
     ...
     */
    app.startLocation = function(params,callback,failCb){
        var corvodaParams = [
            params
        ];
        var callback = callback||function(){};
        ...
        Cordova.exec(successCallback, failCallback, "SzgaPlugin", "startLocation", corvodaParams);
    }
...
//Page 系列
    /**
     * @desc 1、加载h5轻应用接口
     * @input  {  appId:"" , url:"",md5:"" , appEntry:"" , version:""  }
     * @Cordova_input   [ "appId", "url", "md5", "appEntry", "version"]
                        appId:  APP唯一ID
                        url:  APP下载地址
                        md5 ：下载文件MD5值
                        appEntry ：app入口路径
     ...
     * @output 
     */
    app.loadApp = function(params,callback,failCb){
        var CordovaParams = [
            params.appId,
            params.url,
            params.md5,
        ...
        Cordova.exec(successCallback , failCallback, "Page", "loadApp", CordovaParams);
    }
